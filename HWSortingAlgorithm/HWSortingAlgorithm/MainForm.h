...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Text = L"Input 10 numbers (1 Each time)";
			...
			this->textBox1->Location = System::Drawing::Point(15, 26);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(122, 26);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(169, 49);
			...
			this->label3->Location = System::Drawing::Point(15, 93);
			...
			// button3
			// 
			this->button3->Location = System::Drawing::Point(169, 93);
			...
			this->ClientSize = System::Drawing::Size(417, 332);
